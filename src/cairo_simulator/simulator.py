...
class SimObject():
    ...
    def __init__(self, object_name, model_file_or_sim_id, position=(0, 0, 0), orientation=(0, 0, 0, 1)):
        ...
        Args:
            ...
            model_file_or_sim_id (file object, int): Either File object or a PyBulelt body ID.
            position (tuple, optional): Initial position; 3-tuple
            orientation (tuple, optional): Intial orientation; 4-tuple
